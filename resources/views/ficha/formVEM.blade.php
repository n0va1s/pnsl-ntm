<x-layouts.public :title="'Ficha do VEM'">
    <section class="px-4 py-6 w-full max-w-3xl mx-auto" aria-labelledby="page-title">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                <div class="flex items-start gap-3 bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-800 dark:text-gray-100">Pré-VEM: <span class="font-semibold">13/06/2026</span></p>
                        <p class="text-sm font-medium text-gray-800 dark:text-gray-100">VEM: <span class="font-semibold">20 e 21/06/2026</span></p>
                    </div>
                </div>
                <div class="flex items-start gap-3 bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-800 dark:text-gray-100">Paróquia Nossa Senhora do Lago</p>
                    </div>
                </div>
                <div class="flex items-start gap-3 bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-800 dark:text-gray-100">Leves e adequadas para a capela</p>
                    </div>
                </div>
                <div class="flex items-start gap-3 bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-3">
            ...
            <div class="bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-4">
                ...
                <ol class="flex flex-col sm:flex-row gap-4" aria-label="Etapas do processo de inscrição">
                    <li class="flex-1 flex items-start gap-3">
                        <span class="w-7 h-7 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 text-xs font-bold flex items-center justify-center shrink-0" aria-hidden="true">1</span>
                        <div>
                            <p class="text-sm font-semibold text-gray-800 dark:text-gray-100">Pré-inscrição</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Preencha esta ficha e fique atento às informações enviadas por email</p>
                        </div>
                    </li>
                    ...
                    <li class="flex-1 flex items-start gap-3">
                        <span class="w-7 h-7 rounded-full bg-amber-100 dark:bg-amber-900 text-amber-700 dark:text-amber-300 text-xs font-bold flex items-center justify-center shrink-0" aria-hidden="true">2</span>
                        <div>
                            <p class="text-sm font-semibold text-gray-800 dark:text-gray-100">Seleção de fichas</p>
                            <ul class="text-xs text-gray-500 dark:text-gray-400 mt-0.5 space-y-0.5" aria-label="Critérios de seleção">
                    ...
                    <li class="flex-1 flex items-start gap-3">
                        <span class="w-7 h-7 rounded-full bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 text-xs font-bold flex items-center justify-center shrink-0" aria-hidden="true">3</span>
                        <div>
        ...
        @if ($eventos->count() > 0)
            <form
                method="POST"
                x-data="{ bloqueado: {{ $ficha->ind_aprovado ? 'true' : 'false' }} }"
                action="{{ $ficha->exists ? route('vem.update', $ficha) : route('vem.store') }}"
                class="space-y-6"
                novalidate
                aria-label="Formulário de inscrição no VEM">
                @csrf
                @if ($ficha->exists)
                    @method('PUT')
                @endif
                ...
                <fieldset class="bg-white dark:bg-zinc-800 rounded-md shadow p-4 sm:p-6">
                    <legend class="text-lg sm:text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Dados do Participante</legend>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">

                        {{-- Movimento --}}
                        <div>
                            <label for="idt_movimento" class="block font-medium text-gray-700 dark:text-gray-300 mb-1 text-sm sm:text-base">
                                Movimento
                            </label>
                            ...
                            <p id="idt_movimento_hint" class="mt-1 text-xs text-gray-500 dark:text-gray-400">Filtra as opções de evento disponíveis.</p>
                            @error('idt_movimento')
                        ...
                        {{-- Evento --}}
                        <div>
                            <label for="idt_evento" class="block font-medium text-gray-700 dark:text-gray-300 mb-1 text-sm sm:text-base">
                                Evento <span class="text-red-600" aria-hidden="true">*</span><span class="sr-only">(obrigatório)</span>
                            </label>
                        ...
                        {{-- Sexo --}}
                        <div>
                            <label for="tip_genero" class="block font-medium text-gray-700 dark:text-gray-300 mb-1 text-sm sm:text-base">
                            ...
                            <select name="tip_genero" id="tip_genero" required x-bind:disabled="bloqueado"
                                ...
                                <option value="M" {{ old('tip_genero', $ficha->tip_genero) == 'M' ? 'selected' : '' }}>Masculino</option>
                                <option value="F" {{ old('tip_genero', $ficha->tip_genero) == 'F' ? 'selected' : '' }}>Feminino</option>
                            </select>
                            @error('tip_genero')
                                <p class="mt-1 text-sm text-red-600" role="alert">{{ $message }}</p>
                            @enderror
                        ...
                        {{-- Nome completo --}}
                        <div>
                            <label for="nom_candidato" class="block font-medium text-gray-700 dark:text-gray-300 mb-1 text-sm sm:text-base">
                        ...
                        {{-- Apelido --}}
                        <div>
                            <label for="nom_apelido" class="block font-medium text-gray-700 dark:text-gray-300 mb-1 text-sm sm:text-base">
                                Apelido <span class="text-red-600" aria-hidden="true">*</span><span class="sr-only">(obrigatório)</span>
                            </label>
                            <input type="text" name="nom_apelido" id="nom_apelido"
                                x-bind:disabled="bloqueado" required maxlength="100"
                        ...
                        {{-- Data de Nascimento --}}
                        <div>
                            <label for="dat_nascimento" class="block font-medium text-gray-700 dark:text-gray-300 mb-1 text-sm sm:text-base">
                        ...
                        {{-- Whatsapp --}}
                        <div>
                            <label for="tel_candidato" class="block font-medium text-gray-700 dark:text-gray-300 mb-1 text-sm sm:text-base">
                                WhatsApp
                            </label>
                        ...
                        {{-- Email --}}
                        <div>
                            <label for="eml_candidato" class="block font-medium text-gray-700 dark:text-gray-300 mb-1 text-sm sm:text-base">
                        ...
                        {{-- Endereço --}}
                        <div>
                            <label for="des_endereco" class="block font-medium text-gray-700 dark:text-gray-300 mb-1 text-sm sm:text-base">
                                Endereço
                            </label>
                            <input type="text" name="des_endereco" id="des_endereco"
                                x-bind:disabled="bloqueado" maxlength="500" autocomplete="street-address"
                        ...
                        {{-- Tamanho da Camiseta --}}
                        <div>
                            <label for="tam_camiseta" class="block font-medium text-gray-700 dark:text-gray-300 mb-1 text-sm sm:text-base">
                        ...
                        <div>
                            <label for="tip_como_soube" class="block font-medium text-gray-700 dark:text-gray-300 mb-1 text-sm sm:text-base">
                                Como soube do evento
                            </label>
                            <select name="tip_como_soube" id="tip_como_soube" x-bind:disabled="bloqueado"
                                ...
                                <option value="IND" {{ old('tip_como_soube', $ficha->tip_como_soube) == 'IND' ? 'selected' : '' }}>Indicação</option>
                                <option value="PAD" {{ old('tip_como_soube', $ficha->tip_como_soube) == 'PAD' ? 'selected' : '' }}>Padre</option>
                                <option value="OUT" {{ old('tip_como_soube', $ficha->tip_como_soube) == 'OUT' ? 'selected' : '' }}>Outro</option>
                            </select>
                ...
                {{-- ===== RESPONSÁVEIS ===== --}}
                <fieldset class="bg-white dark:bg-zinc-800 rounded-md shadow p-4 sm:p-6">
                    <legend class="text-lg sm:text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Responsáveis</legend>
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                                <div>
                                    <label for="nom_mae" class="block text-sm text-gray-600 dark:text-gray-400 mb-1">Nome</label>
                                    ...
                                    @error('nom_mae')<p class="mt-1 text-sm text-red-600" role="alert">{{ $message }}</p>@enderror
                                </div>
                                <div>
                                    <label for="tel_mae" class="block text-sm text-gray-600 dark:text-gray-400 mb-1">Telefone</label>
                                    <input type="tel" name="tel_mae" id="tel_mae" x-bind:disabled="bloqueado"
                                        ...
                                        autocomplete="off" placeholder="(61) 90000-0000"
                                    ...
                                    @error('tel_mae')<p class="mt-1 text-sm text-red-600" role="alert">{{ $message }}</p>@enderror
                                </div>
                                <div>
                                    <label for="eml_mae" class="block text-sm text-gray-600 dark:text-gray-400 mb-1">Email</label>
                                    <input type="email" name="eml_mae" id="eml_mae" x-bind:disabled="bloqueado"
                                        value="{{ old('eml_mae', optional($ficha->fichaVem)->eml_mae) }}" maxlength="50"
                                        autocomplete="off" placeholder="email@exemplo.com"
                                    ...
                                    @error('eml_mae')<p class="mt-1 text-sm text-red-600" role="alert">{{ $message }}</p>@enderror
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border-t border-gray-100 dark:border-zinc-700 pt-5">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                                <div>
                                    <label for="nom_pai" class="block text-sm text-gray-600 dark:text-gray-400 mb-1">Nome</label>
                                    ...
                                    @error('nom_pai')<p class="mt-1 text-sm text-red-600" role="alert">{{ $message }}</p>@enderror
                                </div>
                                <div>
                                    <label for="tel_pai" class="block text-sm text-gray-600 dark:text-gray-400 mb-1">Telefone</label>
                                    ...
                                    @error('tel_pai')<p class="mt-1 text-sm text-red-600" role="alert">{{ $message }}</p>@enderror
                                </div>
                                <div>
                                    <label for="eml_pai" class="block text-sm text-gray-600 dark:text-gray-400 mb-1">Email</label>
                                    <input type="email" name="eml_pai" id="eml_pai" x-bind:disabled="bloqueado"
                                        value="{{ old('eml_pai', optional($ficha->fichaVem)->eml_pai) }}" maxlength="50"
                                        autocomplete="off" placeholder="email@exemplo.com"
                                    ...
                                    @error('eml_pai')<p class="mt-1 text-sm text-red-600" role="alert">{{ $message }}</p>@enderror
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border-t border-gray-200 dark:border-zinc-600 pt-5">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mt-2">
                                <div>
                                    <label for="nom_responsavel" class="block text-sm text-gray-600 dark:text-gray-400 mb-1">Nome</label>
                                    <input type="text" name="nom_responsavel" id="nom_responsavel" x-bind:disabled="bloqueado"
                                        value="{{ old('nom_responsavel', optional($ficha->fichaVem)->nom_responsavel) }}" maxlength="150"
                                        autocomplete="off" placeholder="Nome completo"
                                    ...
                                    @error('nom_responsavel')<p class="mt-1 text-sm text-red-600" role="alert">{{ $message }}</p>@enderror
                                </div>
                                <div>
                                    <label for="tel_responsavel" class="block text-sm text-gray-600 dark:text-gray-400 mb-1">Telefone</label>
                                    <input type="tel" name="tel_responsavel" id="tel_responsavel" x-bind:disabled="bloqueado"
                                        value="{{ old('tel_responsavel', optional($ficha->fichaVem)->tel_responsavel) }}" maxlength="15"
                                        autocomplete="off" placeholder="(61) 90000-0000"
                                    ...
                                    @error('tel_responsavel')<p class="mt-1 text-sm text-red-600" role="alert">{{ $message }}</p>@enderror
                                </div>
                                <div>
                                    <label for="eml_responsavel" class="block text-sm text-gray-600 dark:text-gray-400 mb-1">Email</label>
                                    <input type="email" name="eml_responsavel" id="eml_responsavel" x-bind:disabled="bloqueado"
                                        value="{{ old('eml_responsavel', optional($ficha->fichaVem)->eml_responsavel) }}" maxlength="50"
                                        autocomplete="off" placeholder="email@exemplo.com"
                                    ...
                                    @error('eml_responsavel')<p class="mt-1 text-sm text-red-600" role="alert">{{ $message }}</p>@enderror
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border-t border-gray-200 dark:border-zinc-600 pt-5 grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6">
                            <div>
                                <label for="idt_falar_com" class="block font-medium text-gray-700 dark:text-gray-300 mb-1 text-sm sm:text-base">
                                    Falar com <span class="text-red-600" aria-hidden="true">*</span><span class="sr-only">(obrigatório)</span>
                                </label>
                                ...
                                @error('idt_falar_com')<p class="mt-1 text-sm text-red-600" role="alert">{{ $message }}</p>@enderror
                            </div>
                            <div>
                                <label for="des_onde_estuda" class="block font-medium text-gray-700 dark:text-gray-300 mb-1 text-sm sm:text-base">
                                    Onde estuda? <span class="text-red-600" aria-hidden="true">*</span><span class="sr-only">(obrigatório)</span>
                                </label>
                                <input type="text" name="des_onde_estuda" id="des_onde_estuda" x-bind:disabled="bloqueado"
                                ...
                                @error('des_onde_estuda')<p class="mt-1 text-sm text-red-600" role="alert">{{ $message }}</p>@enderror
                            </div>
                            <div>
                                <label for="des_mora_quem" class="block font-medium text-gray-700 dark:text-gray-300 mb-1 text-sm sm:text-base">
                                    Mora com quem? <span class="text-red-600" aria-hidden="true">*</span><span class="sr-only">(obrigatório)</span>
                                </label>
                                ...
                                @error('des_mora_quem')<p class="mt-1 text-sm text-red-600" role="alert">{{ $message }}</p>@enderror
                            </div>
                        </div>
                ...
                {{-- ===== FÉ ===== --}}
                <fieldset class="bg-white dark:bg-zinc-800 rounded-md shadow p-4 sm:p-6">
                    <legend class="text-lg sm:text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Outras informações</legend>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div>
                            ...
                            <div class="space-y-2" role="group" aria-labelledby="sacramentos-label">
                                <label class="flex items-center gap-2 cursor-pointer">
                                    ...
                                    <input type="checkbox" name="ind_catolico" value="1" x-bind:disabled="bloqueado"
                                ...
                                <label class="flex items-center gap-2 cursor-pointer">
                                    ...
                                    <input type="checkbox" name="ind_batizado" value="1" x-bind:disabled="bloqueado"
                                ...
                                <label class="flex items-center gap-2 cursor-pointer">
                                    ...
                                    <input type="checkbox" name="ind_primeira_comunhao" value="1" x-bind:disabled="bloqueado"
                                ...
                                <label class="flex items-center gap-2 cursor-pointer">
                                    ...
                                    <input type="checkbox" name="ind_crismado" value="1" x-bind:disabled="bloqueado"
                        ...
                        <div class="space-y-4">
                            <div>
                                <label for="nom_paroquia" class="block font-medium text-gray-700 dark:text-gray-300 mb-1 text-sm sm:text-base">
                                    Paróquia que frequenta
                                </label>
                                <input type="text" name="nom_paroquia" id="nom_paroquia" x-bind:disabled="bloqueado"
                                    value="{{ old('nom_paroquia', optional($ficha->fichaVem)->nom_paroquia) }}" maxlength="150"
                                ...
                                @error('nom_paroquia')<p class="mt-1 text-sm text-red-600" role="alert">{{ $message }}</p>@enderror
                            </div>
                            <div>
                                <p class="font-medium text-gray-700 dark:text-gray-300 mb-1 text-sm sm:text-base" id="instrumento-label">
                                    Toca algum instrumento?
                                </p>
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="hidden" name="ind_toca_instrumento" value="0">
                                    <input type="checkbox" name="ind_toca_instrumento" value="1" x-bind:disabled="bloqueado"
                ...
                <div x-data="{ mostrarRestricoes: {{ old('ind_restricao', $ficha->ind_restricao ?? false) ? 'true' : 'false' }} }">
                    <label class="flex items-start gap-4 p-4 rounded-lg border-2 cursor-pointer transition-colors
                        ...
                        <div>
                            ...
                            <span id="saude-hint" class="text-sm text-amber-700 dark:text-amber-400">
                                Há alguma informação sobre sua saúde que julga importante sabermos? (alergias, restrições alimentares, necessidades especiais)
                            </span>
                        </div>
                        <x-heroicon-o-heart class="w-6 h-6 text-amber-400 dark:text-amber-500 ml-auto shrink-0" aria-hidden="true" />
                    </label>

                    <div x-show="mostrarRestricoes" x-transition
                        class="mt-3 bg-gray-50 dark:bg-zinc-700 rounded-md p-4"
                        role="region" aria-label="Restrições e Alergias">
                        <h3 class="text-base sm:text-lg font-medium mb-3 text-gray-900 dark:text-gray-100">Restrições e Alergias</h3>
                        <div class="space-y-4">
                            @php
                            ...
                            @foreach ($restricoes as $restricao)
                                @php
                                    ...
                                    $complemento = old("complementos.{$restricao->idt_restricao}", $complementos[$restricao->idt_restricao] ?? '');
                                @endphp
                                <div class="space-y-2">
                ...
                {{-- ===== CONSENTIMENTO ===== --}}
                <fieldset class="bg-white dark:bg-zinc-800 rounded-md shadow p-4 sm:p-6">
                    <legend class="text-lg sm:text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Consentimento</legend>
                    <div class="space-y-3">
                        <label class="flex items-start gap-3 cursor-pointer">
                            ...
                            <span class="text-sm sm:text-base text-gray-800 dark:text-gray-100">
                                Estou ciente de que <strong>NÃO É PERMITIDO</strong> sair durante o encontro nem levar o celular para o VEM.
                    ...
                    <div class="mt-6">
                        <label for="txt_observacao" class="block font-medium text-gray-700 dark:text-gray-300 mb-1 text-sm sm:text-base">
                            Com sinceridade na resposta (confidencial): quais os maiores problemas / dificuldades e por que você quer participar do VEM?
                        </label>
                        <textarea name="txt_observacao" id="txt_observacao" rows="4" maxlength="1000"
                            x-bind:disabled="bloqueado"
                            aria-describedby="txt_observacao_hint"
                            placeholder="Escreva com sinceridade. Essa resposta é confidencial."
                        ...
                        @error('txt_observacao')
                            <p class="mt-1 text-sm text-red-600" role="alert">{{ $message }}</p>
                        @enderror
                        <p id="txt_observacao_hint" class="mt-1 text-xs text-gray-500 dark:text-gray-400">Máximo de 1000 caracteres</p>
                    </div>
                </fieldset>
                ...
                @if (Auth::user()?->isAdmin())
                    <fieldset class="bg-white dark:bg-zinc-800 rounded-md shadow p-4 sm:p-6">
                        <legend class="text-lg sm:text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Análise</legend>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            <div>
                                <label for="idt_situacao" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Situação</label>
                            ...
                            <div>
                                <label for="txt_analise" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Análise</label>
        ...
        @else
            <div role="status" aria-live="polite">
                <div class="flex flex-col items-center justify-center text-center p-8 sm:p-10 mt-4 bg-white dark:bg-zinc-800 rounded-xl shadow border border-dashed border-gray-300 dark:border-zinc-600">
                    <x-heroicon-o-user-group class="w-12 h-12 text-gray-400 dark:text-gray-500 mb-4" aria-hidden="true" />
                    <p class="text-base sm:text-lg font-medium text-gray-600 dark:text-gray-300">Nenhum evento disponível no momento</p>
