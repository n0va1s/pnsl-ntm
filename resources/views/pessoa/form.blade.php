                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6" x-data="{
                        ...
                        <template x-if="menorDeIdade">
                            <div
                                class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6 bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                                <div class="md:col-span-2">
                                    <p class="text-blue-800 dark:text-blue-300 font-semibold text-sm mb-2">Informações
                                    ...
                                    <div>
                                        <label for="tel_responsavel"
                                            class="block font-medium text-gray-700 dark:text-gray-300 mb-1">Telefone do
                                            Responsável <span class="text-red-600">*</span></label>
                    ...
                    <div>
                        <label for="eml_pessoa" class="block font-medium text-gray-700 dark:text-gray-300 mb-1">Email
                    ...
                    <div>
                        <label for="tam_camiseta"
                            class="block font-medium text-gray-700 dark:text-gray-300 mb-1">Tamanho da Camiseta <span
                    ...
                    <div>
                        <label for="tip_genero" class="block font-medium text-gray-700 dark:text-gray-300 mb-1">Sexo
                            <span class="text-red-600">*</span></label>
                    ...
                    <label
                        ...
                        <div class="flex-1">
                            <span class="block font-semibold text-amber-800 dark:text-amber-300">Informações de
                                saúde</span>
                            <span class="text-sm text-amber-700 dark:text-amber-400">Alergias, restrições alimentares
