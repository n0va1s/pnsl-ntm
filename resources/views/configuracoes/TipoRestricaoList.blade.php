<x-layouts.app>
    <section class="p-6 w-full max-w-[80vw] ml-auto">
        ...
        <h1 id="titulo-pagina" class="text-2xl font-bold mb-4">Lista de Tipos de Restrição</h1>

        <div class="flex justify-end items-center mb-4">
            <a href="{{ route('restricao.create') }}"
                ...
                aria-label="Cadastrar novo tipo de restrição">
        ...
        <div class="overflow-x-auto mt-4">
            <table
                ...
                <caption id="descricao-tabela" class="sr-only">
                    Tabela com tipos de restrições e ações disponíveis
                </caption>

                <thead class="bg-gray-100">
                    <tr>
                        <th scope="col" class="p-3 font-semibold  dark:text-gray-800">Restrição</th>
                ...
                <tbody>
                    @forelse ($restricoes as $restricao)
                        <tr class="border-t hover:bg-gray-200 dark:hover:bg-gray-500">
                            <td class="p-3 text-gray-900 dark:text-gray-100">{{ $restricao->des_restricao }}</td>

                            <td class="p-3 flex justify-end items-center gap-2">
                                <a href="{{ route('restricao.edit', $restricao->idt_restricao) }}"
                                    ...
                                    aria-label="Editar {{ $restricao->des_restricao }}">
                                    <x-heroicon-o-pencil-square class="w-5 h-5" />
                                    <span class="sr-only sm:not-sr-only">Editar</span>
                                </a>

                                <form action="{{ route('restricao.destroy', $restricao->idt_restricao) }}"
                                    ...
                                    <button type="submit"
                                        ...
                                        aria-label="Excluir {{ $restricao->des_restricao }}">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="p-4 text-center text-gray-500">
                                Nenhum tipo de restrição cadastrado.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
