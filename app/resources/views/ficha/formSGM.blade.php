<x-layouts.app :title="'Ficha do Segue-me'">
    <section class="p-6 w-full max-w-[80vw] ml-auto">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-300">Ficha do Segue-me</h1>
            <p class="text-gray-700 dark:text-gray-500 mt-1">Cadastre uma nova ficha para um dos nossos eventos próximos
            </p>
        </div>
        <div class="flex justify-end mt-4">
            <a href="{{ route('sgm.index') }}"
                ...
                arial-label="Voltar para  lista de fichas">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="idt_movimento" name="idt_movimento" disabled
                                class="w-full rounded-md border border-gray-399 dark:border-zinc-600 px-3 py-2 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('idt_movimento') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            @error('idt_evento') border-red-500 @enderror">
                                ...
                                <option class="dark:bg-zinc-700" value="{{ $evento->idt_evento }}" {{ old('idt_evento', $ficha->idt_evento) ==
                        ...
                        <div>
                            ...
                            @error('tip_genero') border-red-500 @enderror">
                                <option class="dark:bg-zinc-700" value="">Selecione o gênero</option>
                                <option class="dark:bg-zinc-700" value="M" {{ old('tip_genero', $ficha->tip_genero) == 'M' ? 'selected' : ''
                                    }}>Masculino
                                </option>
                                <option class="dark:bg-zinc-700" value="F" {{ old('tip_genero', $ficha->tip_genero) == 'F' ? 'selected' : ''
                                    }}>Feminino
                                </option>
                                <option class="dark:bg-zinc-700" value="O" {{ old('tip_genero', $ficha->tip_genero) == 'O' ? 'selected' : ''
                                    }}>Outro</option>
                            </select>
                            @error('tip_genero')
                        ...
                        <div>
                            ...
                            @error('tam_camiseta') border-red-500 @enderror">
                                ...
                                <option class="dark:bg-zinc-700" value="{{ $tamanho }}" {{ old('tam_camiseta', $ficha->tam_camiseta) == $tamanho
                                    ? 'selected' : '' }}>
                                    {{ $tamanho }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            @error('tip_como_soube') border-red-500 @enderror">
                                ...
                                <option class="dark:bg-zinc-700" value="IND" {{ old('tip_como_soube', $ficha->tip_como_soube) == 'IND' ?
                                    'selected' : '' }}>
                                    Indicação</option>
                                <option class="dark:bg-zinc-700" value="PAD" {{ old('tip_como_soube', $ficha->tip_como_soube) == 'PAD' ?
                                    'selected' : '' }}>
                                    Padre</option>
                                <option class="dark:bg-zinc-700" value="OUT" {{ old('tip_como_soube', $ficha->tip_como_soube) == 'OUT' ?
                                    'selected' : '' }}>
                                    Outro</option>
                            </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        @error('idt_falar_com') border-red-500 @enderror">
                            ...
                            <option class="dark:bg-zinc-700" value="{{ $responsavel->idt_responsavel }}" {{ old('idt_falar_com',
                                optional($ficha->fichaVem)->idt_falar_com) == $responsavel->idt_responsavel ? 'selected'
                                : '' }}>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="idt_situacao" id="idt_situacao" required x-bind:disabled="bloqueado"
                                class="w-full rounded-md border border-gray-300 dark:border-zinc-600 px-3 py-2 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option class="dark:bg-zinc-700" value="">Selecione a situação</option>
                                @foreach ($situacoes as $situacao)
                                <option class="dark:bg-zinc-700" value="{{ $situacao->idt_situacao }}" {{ old('idt_situacao', $ultimaSituacao->
                                    idt_situacao ?? null) == $situacao->idt_situacao ? 'selected' : '' }}>
