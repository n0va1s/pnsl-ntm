<x-layouts.app :title="'Configurações do Sistema'">
    <section class="p-6 w-full max-w-[80vw] ml-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <!-- Card 6 -->
            <a href="{{ route('perfilusuario.index') }}" class="block bg-white dark:bg-zinc-600 rounded-xl shadow hover:shadow-lg transition p-6 text-center">
                <div class="flex flex-col items-center justify-center h-full">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mt-2 text-sm">Defina as permissões de acesso do usuário.</p>
                </div>
            </a>
        </div>
    </section>
