<x-layouts.app :title="'Tipo de Movimento'">
    <section class="p-6 w-full max-w-[80vw] ml-auto">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900">Novo Movimento</h1>
            <p class="text-gray-700 mt-1">Cadastre um novo movimento</p>
        </div>
        ...
        <div class="mb-6 bg-white dark:bg-zinc-800 rounded-md shadow p-6">
            ...
            <form method="POST" action="{{ $tipo->exists ? route('tiposmovimentos.update', $tipo) : route('tiposmovimentos.store') }}" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input
                        ...
                        @error('nom_movimento') border-red-500 @enderror" />
                    @error('nom_movimento')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="w-full rounded-md border border-gray-300 dark:border-zinc-600 px-3 py-2 text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500
                        @error('des_sigla') border-red-500 @enderror" />
                        @error('des_sigla')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
